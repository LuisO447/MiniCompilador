  ...
  public  class TS
    {
      ...
      public void inicialista()
      {
          ...
          tabla_de_simbolos ts = new tabla_de_simbolos("<</","",-0,-0,-0,0,"comentario","inicio de un comentario de mas de una linea","");
            ...
            TSimbolos.Add(ts31);
            tabla_de_simbolos ts32 = new tabla_de_simbolos(">#>si", "", -0, -0, -0, 32, "palabra reservada", "si tal condicion se cumple", "");
            TSimbolos.Add(ts32);
            tabla_de_simbolos ts33 = new tabla_de_simbolos(">#>ysi", "", -0, -0, -0, 33, "palabra reservada", "y si tal condicion se cumple en vez de la anterior", "");
            TSimbolos.Add(ts33);
            ...
            TSimbolos.Add(ts38);
            tabla_de_simbolos ts39 = new tabla_de_simbolos(">#>para", "", -0, -0, -0, 39, "palabra reservada", "for", "");
            TSimbolos.Add(ts39);
            tabla_de_simbolos ts40 = new tabla_de_simbolos(">#>paralista", "", -0, -0, -0, 40, "palabra reservada", "foreach", "");
            TSimbolos.Add(ts40);
